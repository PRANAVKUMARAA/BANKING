...
with open('scaler_mean.pkl', 'rb') as f:
    scaler_kmean=pickle.load(f)

with open('means.pkl', 'rb') as f:
    kmeans=pickle.load(f)

with open('lo_e.pkl', 'rb') as f:
    l_e_t_t=pickle.load(f)

with open("nots.pkl","rb") as f:
...
background_image_path = r'C:\Users\PRANAV\OneDrive\ドキュメント\Banking\image1.png'
